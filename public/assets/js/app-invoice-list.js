            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        var roleBadgeObj = {
                            ...
                            Draft: '<span class="badge badge-center rounded-pill bg-label-primary w-px-30 h-px-30 d-flex align-items-center justify-content-center"><i class="ti ti-device-floppy ti-xs"></i></span>',
                            "Past Due":
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (Auth.user && Auth.user().can("invoice.action")) {
                            // Check if Auth.user exists and is a function
                            actionsHtml = `
            ...
            buttons: [
                {
                    ...
                    action: function (e, dt, button, config) {
                        window.location = baseUrl + "add/invoice";
                    },
                },
            ],
