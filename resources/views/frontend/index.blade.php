...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="assets/img/logo/logo-tourpackage.svg" />
                ...
                <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4 me-xl-8">
                    ...
                    <a href="{{ url('/') }}" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <img width="38" height="38" src="assets/img/logo/logo-tourpackage.svg" alt="Tour Pack" class="logo-icon me-2" />
                        </span>
