        ...
        <div class="col-md-12">
            <div class="nav-align-top">
                <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('agen.profile') }}"><i
                                class="ti-sm ti ti-user-check me-1_5"></i> Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('agen.change.password') }}"><i class="ti-sm ti ti-lock me-1_5"></i>
                            Security</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="col-xl-8 col-lg-7 col-md-7">
            ...
            <div class="card mb-6">
                ...
                <div class="card-body pt-1">
                    <form action="{{ route('agen.password.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
