            ...
            <div class="card-body">
              ...
              <div class="mb-6"></div>
                <div class="alert alert-warning mb-4" role="alert">
                  <strong>Reminder!</strong> Check your email for a message with a link to reset your password. If it doesn't appear within a few minutes, check your spam folder.
                </div>
