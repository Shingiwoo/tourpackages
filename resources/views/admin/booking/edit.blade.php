                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-6">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select required id="status_booking" name="bookingstatus" class="select2 form-select" data-allow-clear="true">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="client-name" name="ClientName" aria-label="Client Name" value="{{ $booking->name }}" />
                                </div>
                            </div>
                            <div class="mb-6">
                        ...
                        <div class="card-body">
                            <div class="row mb-6">
                                <div class="col">
                                    ...
                                    <input type="date" class="form-control" id="startdate-booking" name="startDate" value="{{ $booking->start_date }}" />
                                </div>
                                <div class="col">
                                    <label class="form-label" for="enddate-booking">End Date</label>
                                    <input type="date" class="form-control" id="enddate-booking" name="endDate" value="{{ $booking->end_date }}" />
                                </div>
                            </div>
                            <div class="row mb-4">
                            ...
                            <div class="row">
                                <!-- Kolom Total User -->
                                <div class="col-12 {{ $booking->type === 'rent' ? 'col-md-4' : 'col-md-6' }} mb-6">
                                    <label class="form-label" for="user-total">Total User</label>
                                    <input type="number" class="form-control" id="user-total" name="totalUser" aria-label="Price Total" value="{{ $booking->total_user }}" />
                                </div>
                                ...
                                @if($booking->type === 'rent')
                                    <div class="col-12 col-md-4 mb-6">
                                        ...
                                        <input type="text" class="form-control" id="rent-price" aria-label="Rent Price" value="{{ $booking->price_person }}" />
                                    </div>
                                @endif
                                ...
                                <div class="col-12 {{ $booking->type === 'rent' ? 'col-md-4' : 'col-md-6' }} mb-6">
                                    ...
                                    <input type="text" class="form-control" id="price-perpax" name="pricePerPerson" aria-label="Price Perpax" value="{{ $booking->price_person }}" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-md-4 mb-6">
                                    <label class="form-label" for="price-total">Total Price</label>
                                    <input type="text" class="form-control" id="price-total" name="totalPrice" aria-label="Price Total" value="{{ $booking->total_price }}" />
                                </div>
                                <div class="col-12 col-md-4 mb-6">
                                    <label class="form-label" for="down-payment">Down Payment</label>
                                    <input type="text" class="form-control" id="down-payment" name="downPayment" aria-label="Down Payment" value="{{ $booking->down_paymet }}" />
                                </div>
                                <div class="col-12 col-md-4 mb-6">
                                    <label class="form-label" for="remaining-cost">Remaining Cost</label>
                                    <input type="text" class="form-control" id="remaining-cost" name="remainingCosts" aria-label="Remaining Cost" value="{{ $booking->remaining_costs }}" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (bookingType === "rent") {
                ...
                function updatePrices() {
                    ...
                    let pricePerPerson = totalPrice / totalUser;
                    ...
                    pricePerPersonInput.value = pricePerPerson.toLocaleString("id-ID");
