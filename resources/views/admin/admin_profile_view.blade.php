...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-6">
                <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-5">
                    <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                        <img style="width: 100px; height: 100px" src="{{ (!empty($profileData->photo)) ? url('public/profile/'.$profileData->photo) : url('assets/img/avatars/no_image.jpg') }}" alt="user image"
        ...
        <div class="col-md-12">
            <div class="nav-align-top">
                <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages-profile-teams.html"><i class="ti-sm ti ti-lock me-1_5"></i>
                            Security</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7 col-md-7">
            <form action="{{ route('admin.profile.store') }}" id="formAccountSettings" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-6">
                            <img id="showImage" style="width: 100px; height: 100px" src="{{ asset('assets/img/avatars/no_image.jpg') }}" alt="user-avatar"
                    ...
                    <div class="card-body pt-4">
                        <div class="row">
                            <div class="mb-4 col-md-6">
                                ...
                                <input class="form-control" type="text" id="name" name="name" value="{{ $profileData->name }}" autofocus />
                            </div>
                            <div class="mb-4 col-md-6">
                                <label for="username" class="form-label">Username</label>
                                <input class="form-control" type="text" name="username" id="username" value="{{ $profileData->username }}" />
                            </div>
                            <div class="mb-4 col-md-6">
                            ...
                            <div class="mb-4 col-md-6">
                                ...
                                <input type="text" class="form-control" id="bank" name="bank"
                                    placeholder="BCA" value="{{ $profileData->bank }}"/>
                            </div>
                            <div class="mb-4 col-md-6">
                                <label for="norek" class="form-label">No Rekening</label>
                                <input class="form-control" type="text" id="norek" name="norek"
                                    placeholder="1111111111" value="{{ $profileData->norek }}"/>
                            </div>
                            <div class="mb-4 col-md-12">
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text">Address</span>
                                    <textarea class="form-control" id="address" name="address" aria-label="With textarea">{{ $profileData->address }}</textarea>
                                  </div>
                            </div>
                        </div>
                        <div class="mt-2">
