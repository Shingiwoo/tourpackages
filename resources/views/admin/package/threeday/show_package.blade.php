...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row invoice-add">
        ...
        <div class="col-lg-3 col-12 invoice-actions">
            <div class="card mb-6">
                <div class="card-body">
                    <a href="{{ route('all.threeday.packages') }}" class="btn btn-label-primary w-100 mb-4"><i class="ti ti-arrow-big-left me-2"></i>Back</a>
                    <a href="{{ route('edit.threeday.package', $package->id) }}" class="btn btn-label-warning w-100 mb-4"><i class="ti ti-edit me-2"></i>Edit</a>
                </div>
            </div>
        </div>
        <!-- /Actions -->
