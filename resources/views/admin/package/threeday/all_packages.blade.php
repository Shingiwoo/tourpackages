                ...
                <div class="card-header flex-column flex-md-row">
                    ...
                    <div class="dt-action-buttons text-end pt-6 pt-md-0">
                        <div class="dt-buttons btn-group flex-wrap">
                            ...
                            <a href="{{ route('generate.threeday.package') }}"
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a class="dropdown-item text-info" href="{{ route('show.threeday.package', $pack->id) }}"><i
                                                            class="ti ti-eye"></i>View</a></li>
                                                @endif
                                                @if (Auth::user()->can('package.edit'))
                                                <li><a class="dropdown-item text-warning"
                                                        href="{{ route('edit.threeday.package', $pack->id) }}"><i
                                                ...
                                                <li><a href="javascript:void(0)"
                                                        ...
                                                        data-id="{{ $pack->id }}"
                                                        data-url="{{ route('delete.threeday.package', $pack->id) }}"> <i
    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form id="threedayModalForm" class="row g-6" method="POST" action="{{ route('booking.save') }}">
                    @csrf
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-12 col-md-6 mb-4">
                            <label for="threeday_packageType" class="form-label">Package Type</label>
                            <input type="text" id="threeday_packageType" name="modalPackageType" class="form-control" placeholder="Three Day" value="threeday" readonly/>
                        </div>
                        <div class="col-12 col-md-6 mb-4">
...
<script>
    function updateAgenUrl() {
        ...
        if (agenId) {
            showAgenPackagesBtn.href = `{{ url('/packages/threeday/agen') }}/${agenId}`;
    ...
    // Form Booking threeday Package
    document.addEventListener('DOMContentLoaded', function() {
        const form = document.getElementById('threedayModalForm');
        ...
        form.addEventListener('submit', function(e) {
            // Pastikan nilai package type di-set ke 'threeday'
            const packageTypeInput = document.getElementById('threeday_packageType');
            packageTypeInput.value = 'threeday';
