    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card-header d-flex justify-content-between">
            <div class="card-title mb-4">
                <h5 class="mb-1">All Data Twoday Packages For - <span class="text-uppercase">{{ $agen->username }}</span>
                </h5>
                            ...
                            <div class="accordion mt-4" id="accordionWithIcon">
                                <div class="accordion-item card bg-secondary">
                                    <h2 class="accordion-header d-flex align-items-center">
                                        <button type="button" class="accordion-button collapsed btn-secondary"
                                            data-bs-toggle="collapse" data-bs-target="#accordionWithIcon-2"
                                            aria-expanded="false">
                                                ...
                                                <div class="table-responsive text-nowrap">
                                                    <table class="table table-bordered">
                                                                        ...
                                                                        foreach ($group['data'] as $priceRow) {
                                                                            foreach ($priceRow as $key => $value) {
                                                                                if (
                                                                                    ...
                                                                                    $accommodationTypes[$key] = ucwords(
                                                                                        str_replace(
                                                                                            [
                                                                                                'WithoutAccomodation',
                                                                                                'Guesthouse',
                                                        ...
                                                        @if (is_array($prices) && count($prices) > 0)
                                                            @foreach ($prices as $group)
                                                                ...
                                                                <thead class="align-content-center text-center">
                                                                    <tr>
                                                                        <th colspan="{{ 4 + count($accommodationTypes) }}"
                                                                            class="text-center">{{ $priceType }}</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="align-content-center text-center">Price
                                                                            Type</th>
                                                                        <th class="align-content-center text-center">Vehicle
                                                                        </th>
                                                                        <th class="align-content-center text-center">User
                                                                        </th>
                                                                        <th class="align-content-center text-center">WNA
                                                                            Cost</th>
                                                                ...
                                                                <tbody>
                                                                    @if (!empty($group['data']) && is_array($group['data']))
                                                                        @foreach ($group['data'] as $index => $priceRow)
                                                                            @if ($index !== 0)
                                                                                <!-- Melewati objek pertama yang hanya berisi "Price Type" -->
                                                                                <tr>
                                                                                    <td
                                                                                    ...
                                                                                    <td
                                                                                        class="align-content-center text-center">
                                                                                        {{ number_format($priceRow['wnaCost'] ?? 0, 0, ',', '.') }}
                                                                                        /org</td>
                                                                                    @foreach ($accommodationTypes as $typeKey => $typeLabel)
                                                                                        <td
                                                                                            class="align-content-center text-center">
                                                                                            {{ number_format($priceRow[$typeKey] ?? 0, 0, ',', '.') }}
                                                                                            /org</td>
                                                                                    @endforeach
                                                                                </tr>
                                                                            @endif
                                                                    ...
                                                                    @else
                                                                        <tr>
                                                                            <td colspan="{{ 4 + count($accommodationTypes) }}"
                                                                                class="text-center">No price data available
                                                                            </td>
                                                                        </tr>
                                                                    @endif
                                                                </tbody>
                                                        ...
                                                        @else
                                                            <tr>
                                                                <td colspan="{{ 4 + count($accommodationTypes) }}"
                                                                    class="text-center">No price data available</td>
                                                            </tr>
                                                        @endif
                                                    </table>
                                                </div>
