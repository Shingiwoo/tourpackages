...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row g-6 mb-6">
        <div class="col-sm-6 align-self-center text-center">
            <h2 class="text-uppercase text-primary">One Day Package</h2>
        </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a class="dropdown-item text-info" href="{{ route('show.package', $pack->id) }}"><i
                                                            class="ti ti-eye"></i>View</a></li>
                                                @endif
                                                @if (Auth::user()->can('package.add'))
                                                <li><a class="dropdown-item text-warning"
                                                        href="{{ route('edit.package', $pack->id) }}"><i
                                                ...
                                                <li><a href="javascript:void(0)"
                                                        ...
                                                        data-id="{{ $pack->id }}"
                                                        data-url="{{ route('delete.package', $pack->id) }}"> <i
    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form id="onedayModalForm" class="row g-6" method="POST" action="{{ route('booking.save') }}">
                    @csrf
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-12 col-md-4 mb-4">
                            <label for="oneday_packageType" class="form-label">Package Type</label>
                            <input type="text" id="oneday_packageType" name="modalPackageType" class="form-control" placeholder="One Day" value="oneday" readonly/>
                        </div>
                        <div class="col-12 col-md-4 mb-4">
...
<script>
    ...
    // Form Booking oneday Package (kode Anda, tidak perlu diubah)
    document.addEventListener('DOMContentLoaded', function() {
        const form = document.getElementById('onedayModalForm');
        ...
        form.addEventListener('submit', function(e) {
            // Pastikan nilai package type di-set ke 'oneday'
            const packageTypeInput = document.getElementById('oneday_packageType');
            packageTypeInput.value = 'oneday';
