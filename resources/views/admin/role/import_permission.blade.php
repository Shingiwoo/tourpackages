...
<div class="container-xxl flex-grow-1 container-p-y">
    <form id="mydata" action="{{ route('import.permission') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="app-ecommerce">
            ...
            <div
                ...
                <div class="d-flex flex-column justify-content-center">
                    <h4 class="mb-1">Mass add a new Permissions</h4>
                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="card mb-6">
                        <div class="card-header">
                            <h5 class="card-tile mb-0">Permission File</h5>
                        </div>
                        <div class="card-body">
                            <div class="row mb-6">
                                <div class="col">
