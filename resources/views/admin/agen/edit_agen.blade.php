        ...
        <div class="col-lg-8 mb-6">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Add Agen</h5>
                    <small class="text-muted float-end">Set Agen With Role</small>
                </div>
                <div class="card-body">
                    <form class="border rounded p-3 p-md-5" action="{{ route('update.agen', $user->id)}}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col mb-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-6">
                                ...
                                <select required id="status" name="agenStatus" class="select2 form-select"
                                    data-allow-clear="true">
